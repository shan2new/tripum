...
export const CARDS: StepCard[] = [
  ...
  },
  {
    ...
    dayDate: "2026-03-01",
    sortOrder: 6,
    title: { en: "Ramalingum & Vishwalingum Darshan", hi: "रामलिंगम और विश्वलिंगम दर्शन" },
    subtitle: { en: "Sacred Lingams — Phase 3 of 3", hi: "पवित्र लिंगम — चरण 3/3" },
  ...
  },
  {
    ...
    timeWindow: "4:30 – 7:30 PM",
    durationMin: 180,
    icon: "MapPin",
    heroImage: "/images/dhanushkodi.svg",
    tip: {
      en: "20 km from temple. 3-hour round trip. Take own car or hire jeep (₹600-800).",
      hi: "मंदिर से 20 किमी दूर। आने-जाने में 3 घंटे। अपनी गाड़ी ले जाएँ या जीप किराए पर लें (₹600-800)।",
    },
    carry: [

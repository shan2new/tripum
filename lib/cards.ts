...
export const CARDS: StepCard[] = [
  ...
  },
  {
    ...
    timeWindow: "5:00 – 7:30 PM",
    durationMin: 150,
    icon: "Landmark",
    heroImage: "/images/ramanathaswamy-corridor.svg",
    tip: {
      en: "Just a recon walk. Save energy for tomorrow's 4:30 AM start. Dress code: modest Indian attire.",
      hi: "सिर्फ देखने जाना है। कल सुबह 4:30 के लिए ऊर्जा बचाएं। ड्रेस कोड: भारतीय पोशाक।",
    },
    carry: [
  ...
  // ─── DAY 1 — Mar 1 (Sunday): Core Darshan Day ───
  {
    ...
    timeWindow: "5:00 – 5:45 AM",
    durationMin: 45,
    icon: "Sparkles",
    heroImage: "/images/spatika-lingam.svg",
    tip: {
      en: "₹50/person ticket at East Gate counter. Opens only 5–6 AM — don't be late.",
      hi: "₹50/व्यक्ति टिकट पूर्वी गेट पर। सिर्फ 5–6 AM खुलता है — देर मत करें।",
    },
